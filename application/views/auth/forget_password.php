...
<form action="<?php echo base_url() ?>Login/search" method="post">
                    ...
                    <div class="col-lg-6">
                        <div class="card2 card border-0 px-4 py-5">
                            <div class="row mb-4 px-3">
                                <h1 class="mb-0 mr-4 ">Form reset password</1>
                            ...
                            <div class="row px-3">
                                <label class="mb-1">
                                    <h6 class="mb-0 text-sm">Masukan Username</h6>
                                </label>
                            ...
                            <div class="row mb-3 mt-2 px-3">
                                <button type="submit" class="btn btn-blue text-center">cari <i class="fas fa-search"></i></button>
                            </div>
                            <div class="row mb-4 px-3">
