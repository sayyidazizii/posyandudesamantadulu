...
<head>
    ...
    <title>SIP - posyandudesamantadulu</title>
...
<form action="<?php echo base_url() ?>Login/save_pass" method="post">
                ...
                <div class="row d-flex">
                    <div class="col-lg-6">
                        <div class="card2 card border-0 px-4 py-5">
                            ...
                            ?>
                                <div class="alert alert-danger" role="alert">Username yang Anda masukkan salah / tidak ada!</div>
                            <?php
                            }
                            ?>
                            <div class="row px-3">
                                ...
                                <input hidden class="mb-4" type="text" name="id_admin" placeholder="Enter a valid username" value="<?php echo $id_admin ?>" readonly>
                                <input class="mb-4" type="text" name="username" placeholder="Enter a valid username" value="<?php echo $username ?>" readonly>
                            </div>
                            <div class="row px-3">
                                <label class="mb-1">
                                    <h6 class="mb-0 text-sm">Password Baru</h6>
                                </label>
