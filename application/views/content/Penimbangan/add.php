                       ...
                       <form action="<?= base_url() ?>penimbangan/process-add" method="post">
                            <table style="width: 100%">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <th>Berat Badan</th>
                                    <td><input type="text" name="berat_badan" id="berat_badan" class="form-control form-control-sm my-2 border-dark" required ></td>
                                </tr>
                                 <tr>
                                    <th>Tinggi Badan</th>
                                    <td><input type="text" name="tinggi_badan" id="tinggi_badan" class="form-control form-control-sm my-2 border-dark" required ></td>
                                </tr>
                                <tr>
                                    <th>Lingkar Kepala</th>
                                    <td><input type="text" name="lingkar_kepala" id="lingkar_kepala" class="form-control form-control-sm my-2 border-dark" required ></td>
                                </tr>
                                <tr>
                                    <th>Lingkar Perut</th>
                                    <td><input type="text" name="lingkar_perut" id="lingkar_perut" class="form-control form-control-sm my-2 border-dark" required ></td>
                                </tr>
                                <tr>
                                    <th>Keterangan</th>
