                ...
                <div class="container">
                    <form action="<?= base_url() ?>penimbangan/process-edit" method="post">
                        <table style="width: 100%">
                            <td><input type="text" required hidden name="id_timbangan" id="id_timbangan" class="form-control form-control-sm my-2 border-dark" value="<?php echo $penimbangan->id_timbangan ?>" required readonly></td>
                            <tr>
                                <th>NIB</th>
                                <td>
                            ...
                            <tr>
                                <th>Usia (Bln)</th>
                                <td><input type="decimal" oninput="validateNumber(this)" name="usia" id="usia" class="form-control form-control-sm my-2 border-dark" required></td>
                            </tr>
                            <tr>
                                <th>Berat Badan (kg)</th>
                                <td><input type="decimal" oninput="validateNumber(this)" name="berat_badan" id="berat_badan" class="form-control form-control-sm my-2 border-dark" value="<?php echo $penimbangan->berat_badan ?>"></td>
                            </tr>
                            <tr>
                                <th>Tinggi Badan (cm)</th>
                                <td><input type="decimal" oninput="validateNumber(this)" name="tinggi_badan" id="tinggi_badan" class="form-control form-control-sm my-2 border-dark" value="<?php echo $penimbangan->tinggi_badan ?>"></td>
                            </tr>
                            <tr>
                                <th>Lingkar Kepala (cm)</th>
                                <td><input type="decimal" oninput="validateNumber(this)" name="lingkar_kepala" id="lingkar_kepala" class="form-control form-control-sm my-2 border-dark" value="<?php echo $penimbangan->lingkar_kepala ?>"></td>
                            </tr>
                            <tr>
                                <th>Lingkar Perut (cm)</th>
                                <td><input type="decimal" oninput="validateNumber(this)" name="lingkar_perut" id="lingkar_perut" class="form-control form-control-sm my-2 border-dark" value="<?php echo $penimbangan->lingkar_perut ?>" required></td>
                            </tr>
                            <tr>
                                <th>Keterangan</th>
                                <td><input type="text" oninput="validateText(this)" name="keterangan" id="keterangan" class="form-control form-control-sm my-2 border-dark" value="<?php echo $penimbangan->keterangan ?>"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td><button type="submit" class="btn btn-primary my-2">Simpan</button>
                                    <a href="<?php echo base_url() ?>Penimbangan" class="btn btn-primary my-2">cancel</a>
                                </td>
                            </tr>
                        </table>
                    </form>
