                ...
                <div class="container">
                    <form action="<?= base_url() ?>penimbangan/process-edit" method="post">
                        <table style="width: 100%">
                            ...
                            <tr>
                                <th>Usia (Bln)</th>
                                <td><input type="decimal" name="usia" id="usia" class="form-control form-control-sm my-2 border-dark" required></td>
                            </tr>
                            <tr>
                                <th>Berat Badan (kg)</th>
                                <td><input type="decimal" name="berat_badan" id="berat_badan" class="form-control form-control-sm my-2 border-dark" value="<?php echo $penimbangan->berat_badan ?>"></td>
                            </tr>
                            <tr>
                                <th>Tinggi Badan (cm)</th>
                                <td><input type="decimal" name="tinggi_badan" id="tinggi_badan" class="form-control form-control-sm my-2 border-dark" value="<?php echo $penimbangan->tinggi_badan ?>"></td>
                            </tr>
                            <tr>
                                <th>Lingkar Kepala (cm)</th>
                                <td><input type="decimal" name="lingkar_kepala" id="lingkar_kepala" class="form-control form-control-sm my-2 border-dark" value="<?php echo $penimbangan->lingkar_kepala ?>"></td>
                            </tr>
                            <tr>
                                <th>Lingkar Perut (cm)</th>
                                <td><input type="decimal" name="lingkar_perut" id="lingkar_perut" class="form-control form-control-sm my-2 border-dark" value="<?php echo $penimbangan->lingkar_perut ?>" required></td>
                            </tr>
                            <tr>
                                <th>Keterangan</th>
