            ...
            <div class="card mb-4">
                ...
                <div class="container">
                    ...
                    <div class="table-responsive">
                        <table border="1" cellspacing="0" cellpadding="5" width="100%" class="table align-items-center table-flush table-hover" id="dataTableHover2">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>NIB</th>
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="<?php echo base_url() ?>report/rekapimunisasi/cetak?start_date=<?= $start_date ?>&end_date=<?= $end_date ?>" target="_blank" class="btn btn-primary mx-2 my-2">Cetak pdf</a>
                            <a href="<?php echo base_url() ?>report/rekapimunisasi/export?start_date=<?= $start_date ?>&end_date=<?= $end_date ?>" target="_blank" class="btn btn-primary mx-2 my-2">Export</a>
