                ...
                <div class="container">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="<?php echo base_url() ?>report/rekappenimbangan/cetak?start_date=<?= $start_date ?>&end_date=<?= $end_date ?>" target="_blank" class="btn btn-primary mx-2 my-2">Cetak pdf</a>
                            <a href="<?php echo base_url() ?>report/rekappenimbangan/export?start_date=<?= $start_date ?>&end_date=<?= $end_date ?>" target="_blank" class="btn btn-primary mx-2 my-2">Export</a>
