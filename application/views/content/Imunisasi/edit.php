                  ...
                  <div class="container">
                       <form action="<?= base_url() ?>imunisasi/process-edit" method="post">
                            <table style="width: 100%">
                                    <td><input type="text" hidden name="id_imunisasi" id="id_imunisasi" class="form-control form-control-sm my-2 border-dark"  value="<?php echo $imunisasi->id_imunisasi ?>" required readonly></td>
                                <tr>
                                    <th>NIB</th>
                                    <td>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <th>Imunisasi</th>
                                    <td><input type="text" name="imunisasi" id="imunisasi" class="form-control form-control-sm my-2 border-dark" value="<?php echo $imunisasi->imunisasi ?>" required ></td>
                                </tr>
                                 <tr>
                                    <th>Vitamin A</th>
                                    <td>
                                        <div class="my-2">
                                            <div class="d-flex flex-nowrap">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="merah" name="vitamin" value="merah" class="custom-control-input" <?php if ($imunisasi->vitamin == "merah") {echo "checked";} ?>>
                                                    <label class="custom-control-label" for="merah">Merah</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="biru" name="vitamin" value="biru" class="custom-control-input" <?php if ($imunisasi->vitamin == "biru") {echo "checked";} ?>>
                                ...
                                <tr>
                                    <th>Keterangan</th>
                                    <td><input type="text" name="keterangan" id="keterangan" class="form-control form-control-sm my-2 border-dark" value="<?php echo $imunisasi->keterangan ?>"></td>
                                </tr>
                                <tr>
                                    <th></th>
