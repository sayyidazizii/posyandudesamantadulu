                  ...
                  <div class="container">
                       <form action="<?= base_url() ?>/balita/process-add" method="post">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <th>Usia</th>
                                    <td><input type="text" name="usia" id="usia" class="form-control form-control-sm my-2 border-dark"></td>
                                </tr>
                                <tr>
                                    <th>Nama Ayah</th>
                                    <td><input type="text" name="nama_ayah" id="nama_ayah" class="form-control form-control-sm my-2 border-dark"></td>
                                </tr>
                                <tr>
                                    <th>Nama Ibu</th>
                                    <td><input type="text" name="nama_ibu" id="nama_ibu" class="form-control form-control-sm my-2 border-dark"></td>
                                </tr>
                                <tr>
                                    <th></th>
